...
import Cardforlikecommandsshare from './Cardforlikecommandsshare'
...
const Centergroup = () => {
  return (
    ...
    <div className='fic justify-evenly py-2 border-b-[1px] border-[#3a3b3c] '>
      ...
      <Cardforlikecommandsshare name={"Like"} Icon = {Icons.like}/>
      <Cardforlikecommandsshare name={"Comment"} Icon = {Icons.comment}/>
      <Cardforlikecommandsshare name={"Share"} Icon = {Icons.share}/>
    </div>
  </div>
    <div className='w-[80%] my-5 bg-[#242626]  bg-[#3a] rounded-lg mx-auto '>
    <div className='fic gap-2 pt-2 w-[95%] mx-auto  justify-between' >
